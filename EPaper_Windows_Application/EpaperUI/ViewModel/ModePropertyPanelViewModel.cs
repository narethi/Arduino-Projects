...
namespace EpaperUI.ViewModel.EPaperControlViewModels
{
    public class ModePropertyPanelViewModel : BaseViewModel
    {
        ...
        private void UpdateControlVisibilityProperties()
        {
            ...
            OnPropertyChanged(nameof(SleepModeControlVisibility));
        }
        ...
        public Visibility SleepModeControlVisibility => DeviceMode == DisplayMode.Sleep ? Visibility.Visible : Visibility.Collapsed;
    }
}
